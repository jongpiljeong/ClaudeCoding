...
```diff
- 오늘의 날씨와 주요 뉴스를 보여 주는 나만의 시작 홈페이지를 만들고 싶어 (X)
```
업데이트 안내: 클로드 아티팩트의 외부 API 정책 변경으로 날씨와 뉴스를 불러오지 못하게 되었습니다. 다음과 같이 대체해 실행해 주세요.

새 아티팩트 선택 후 아래 사진처럼 **[처음부터 시작하기]** 를 선택
<div align="center">
...
이후 추가 질문에 답하면서 첫 아티팩트를 완성해 보세요. 나머지 **게시**, **커스터마이즈** 관련 내용은 책의 내용에 기반하여 그대로 실행하시면 됩니다.
...
설치 방법이 업데이트 되었습니다. 아래 **[업데이트된 설치 가이드]** 를 참고해 주세요.

- [윈도우 설치 가이드 (업데이트)](설치가이드/3장_윈도우_설치가이드.pdf)
- [macOS/리눅스 설치 가이드 (업데이트)](설치가이드/3장_맥OS리눅스_설치가이드.pdf)
